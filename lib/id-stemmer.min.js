(function (global, factory) {
  ...
  var IrregularWords = /** @class */ (function () {
    ...
    IrregularWords.loadWords = function (filename, chopped) {
      ...
      if (chopped) {
        contents = contents.map(function (word) {
    ...
    IrregularWords.ENDS_WITH_SUFFIX_CHARACTERS = ["majikan"].concat(
  ...
  IrregularWords.SPECIAL_LETTERS.map(function (letter) {
    // console.log(letter)
    IrregularWords["BEGINS_WITH_" + letter] = IrregularWords.loadWords(
      "" + letter.toLowerCase(),
      true
    );
  });
  ...
  var MorphologicalUtility = /** @class */ (function () {
    function MorphologicalUtility() {
      ...
      this.totalSyllables = function (word) {
        ...
        for (var _i = 0, word_1 = word; _i < word_1.length; _i++) {
          var value = word_1[_i];
          if (_this.isVowel(value)) result++;
        }
        return result;
      };
      this.removeParticle = function (word) {
        _this.numberOfSyllables =
          _this.numberOfSyllables || _this.totalSyllables(word);
        word = _this.removeCharactersMatchingCollection(
          word,
          _this.collectionFor("particle"),
          Position.end
        );
        return word;
      };
      this.removePossessivePronoun = function (word) {
        _this.numberOfSyllables =
          _this.numberOfSyllables || _this.totalSyllables(word);
        return _this.removeCharactersMatchingCollection(
          word,
          _this.collectionFor("possessive_pronoun"),
          Position.end
        );
      };
      this.removeFirstOrderPrefix = function (word) {
        _this.numberOfSyllables =
          _this.numberOfSyllables || _this.totalSyllables(word);
        var prevWord = word;
        word = _this.removeAndSubstituteCharactersMatchingCollection(
          word,
          _this.collectionFor("special_first_order_prefix"),
          Position.start
        );
        if (prevWord !== word) {
          return word;
        ...
        word = _this.removeCharactersMatchingCollection(
          word,
          _this.collectionFor("first_order_prefix"),
          Position.start
        );
        return word;
      };
      this.removeSecondOrderPrefix = function (word) {
        var REMOVED_BER = MorphologicalUtility.REMOVED_BER,
          SPECIAL_SECOND_ORDER_PREFIX_WORDS =
            MorphologicalUtility.SPECIAL_SECOND_ORDER_PREFIX_WORDS;
        _this.numberOfSyllables =
          _this.numberOfSyllables || _this.totalSyllables(word);
        ...
        return _this.removeCharactersMatchingCollection(
          word,
          _this.collectionFor("non_special_second_order_prefix"),
          Position.start
        );
      };
      this.removeSuffix = function (word) {
        var REMOVED_KE = MorphologicalUtility.REMOVED_KE,
          REMOVED_PENG = MorphologicalUtility.REMOVED_PENG,
          REMOVED_PE = MorphologicalUtility.REMOVED_PE,
          REMOVED_DI = MorphologicalUtility.REMOVED_DI,
          REMOVED_MENG = MorphologicalUtility.REMOVED_MENG,
          REMOVED_TER = MorphologicalUtility.REMOVED_TER,
          REMOVED_BER = MorphologicalUtility.REMOVED_BER,
          SUFFIX_CHARACTERS = MorphologicalUtility.SUFFIX_CHARACTERS;
        if (_this.ambiguousWithSufficesEndingWords(word)) return word;
        _this.numberOfSyllables =
          _this.numberOfSyllables || _this.totalSyllables(word);
        var constantToCheck = [];
        ...
        for (var index = 0; index < SUFFIX_CHARACTERS.length; index++) {
          ...
          if (
            ...
            constantToCheck.every(function (cons) {
              return ((_this.flags || 0) & cons) === 0;
            })
          ) {
            _this.reduceSyllable();
            word = _this.sliceWordAtPosition(
              word,
              character.length,
              Position.end
            );
    ...
    MorphologicalUtility.prototype.ambiguousWithSufficesEndingWords = function (
      word
    ) {
      return IrregularWords.ENDS_WITH_SUFFIX_CHARACTERS.includes(word);
    };
    MorphologicalUtility.prototype.removeCharactersMatchingCollection =
      function (word, collection, position) {
        // tslint:disable-next-line:prefer-for-of
        for (var index = 0; index < collection.length; index++) {
          ...
          if (
            ...
            this.flags =
              this.flags || this.collectionFor(characters, "removed");
            this.reduceSyllable();
    ...
    MorphologicalUtility.prototype.sliceWordAtPosition = function (
      word,
      characterSize,
      position
    ) {
    ...
    MorphologicalUtility.prototype.removeAndSubstituteCharactersMatchingCollection =
      function (word, collection, position) {
        // tslint:disable-next-line:prefer-for-of
        for (var index = 0; index < collection.length; index++) {
          var characters = collection[index];
          var matched = this.matchingCharactersRequiresSubstitution(
            word,
            characters,
            position
          );
    ...
    MorphologicalUtility.prototype.matchingCharactersRequiresSubstitution =
      function (word, characters, position) {
        return (
    ...
    MorphologicalUtility.prototype.matchCharactersPositionFollowedByVowel =
      function (word, characters, position) {
        var wordLength = word.length;
        var characterSize = characters.length;
        var Pos = "is" + position + "sWith";
        return (
          StemmerUtility[Pos](word, wordLength, characters) &&
          wordLength > characterSize &&
          this.isVowel(word[characterSize])
        );
      };
    MorphologicalUtility.prototype.substitutionRequired = function (
      word,
      characters
    ) {
      return (
    ...
    MorphologicalUtility.prototype.containsIrregularPrefix = function (
      word,
      characters
    ) {
      var irregularOnPrefix = Object.keys(
        IrregularWords.ON_PREFIX_CHARACTERS
      ).includes(characters);
    ...
    MorphologicalUtility.prototype.substituteWordCharacter = function (
      word,
      characters
    ) {
      var substituteChar = "";
    ...
    MorphologicalUtility.prototype.collectionFor = function (name, type) {
      ...
      return MorphologicalUtility[staticMethod];
    };
    MorphologicalUtility.prototype.matchPositionAndNotAmbiguousWithCharacters =
      function (word, characters, position) {
        var pos = "is" + position + "sWith";
        return (
          StemmerUtility[pos](word, word.length, characters) &&
          !this.ambiguousWithCharacters(word, characters, position)
        );
      };
    MorphologicalUtility.prototype.ambiguousWithCharacters = function (
      word,
      characters,
      position
    ) {
      if (position === Position.start) {
        ...
        return IrregularWords.ENDS_WITH_COMMON_CHARACTERS[characters].some(
          function (ambiguousWord) {
            var prefix = ["me", "be", "pe"];
    ...
    MorphologicalUtility.prototype.choppedWordMatchWordsCollection = function (
      choppedWord,
      collection
    ) {
      return collection.some(function (word) {
        return StemmerUtility.isStartsWith(
          choppedWord,
          choppedWord.length,
          word
        );
    ...
    MorphologicalUtility.SECOND_ORDER_PREFIX_CHARACTERS = [
      "ber",
      "be",
      "per",
      "pe",
    ...
    MorphologicalUtility.NON_SPECIAL_SECOND_ORDER_PREFIX_CHARACTERS = [
      "ber",
      "per",
      "pe",
    ];
  ...
  var Stemmer = /** @class */ (function (_super) {
    ...
    function Stemmer() {
      ...
      _this.stem = function (word, derivationalStemming) {
        if (derivationalStemming === void 0) {
          derivationalStemming = true;
        }
